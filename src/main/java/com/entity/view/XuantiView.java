 ...
 */
@TableName("xuanti")
public class XuantiView extends XuantiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 审核状态的值
		*/
		private String xuantiValue;
	...
	public XuantiView(XuantiEntity xuantiEntity) {
		try {
			BeanUtils.copyProperties(this, xuantiEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getXuantiValue() {
				return xuantiValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setXuantiValue(String xuantiValue) {
				this.xuantiValue = xuantiValue;
			}
